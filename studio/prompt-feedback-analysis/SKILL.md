...
description: Use this skill when analyzing local Draw Things prompt feedback archives, if present, to identify prompt patterns and generate practical guidance for future prompt editing.
---
...
Read project-local rating archives when they exist:
...
- Existing hand-written case notes when relevant
